...
$factory->define(App\Models\Member::class, function (Faker\Generator $faker) {
	...
	return [
		...
		'instructor' => $faker->boolean(5),
		'tow_pilot' => $faker->boolean(10),
		...
		'silver_duration' => $faker->boolean(5),
		'silver_distance' => $faker->boolean(5),
		'silver_height' => $faker->boolean(10),
		'gold_distance' => $faker->boolean(10),
		'gold_height' => $faker->boolean(10),
		'coach' => $faker->boolean(10),
		'privacy' => $faker->boolean(10),
		'contest_pilot' => $faker->boolean(5),
