		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<form class="form-horizontal" role="form" method="POST" action="{{ url('/activate') }}">
					...
					<div class="form-group{{ $errors->has('gnz_id') ? ' has-error' : '' }}">
						<label class="col-md-4 control-label">GNZ Number (Optional)</label>

						<div class="col-md-6">
							<input type="text" class="form-control" name="gnz_id" value="{{ old('gnz_id', $user->gnz_id) }}">

							@if ($errors->has('gnz_id'))
								<span class="help-block">
									<strong>{{ $errors->first('gnz_id') }}</strong>
								</span>
							@endif
						</div>
					</div>
