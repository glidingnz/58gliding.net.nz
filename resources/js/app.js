...
Vue.component('member-log', require('./components/Members/MemberLog.vue').default);
Vue.component('edit-member-affiliates', require('./components/members/EditMemberAffiliates.vue').default);
...
Vue.component('global-settings', require('./components/admin/GlobalSettings.vue').default);
